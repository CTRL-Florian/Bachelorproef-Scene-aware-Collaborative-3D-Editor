  ...
  return (
    <div ref={ref} data-submenu="true" style={{ position: "fixed", top: (() => {
      ...
      <div style={{ background: "#fff", minWidth: 200, padding: 12, border: "none", boxShadow: "0 2px 8px rgba(0,0,0,0.12)", borderRadius: 6 }}>
        <div style={{ fontWeight: "bold", marginBottom: 4, fontSize: 13 }}>Resize: {boxId}</div>
        ...
        <Button size="sm" variant="outline" onClick={() => onResize(absolute, offset)} style={{ fontSize: 12, padding: "4px 8px", height: "auto", width: "100%" }}>Resize</Button>
      </div>
    </div>
  );
};
